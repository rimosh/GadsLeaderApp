...
import com.techno.job.gadsleaderapp.fragment.LearningLeadersFragment;
import com.techno.job.gadsleaderapp.fragment.SkilliQFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent submitActivity = new Intent(LeaderBoardActivity.this, SubmitProjectActivity.class);
