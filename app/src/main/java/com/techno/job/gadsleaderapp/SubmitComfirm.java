...
import com.techno.job.gadsleaderapp.services.SubmitToGoogleFormsWebService;
...
public class SubmitComfirm extends Activity {
            ...
            public void onClick(View view) {
                ...
                submitProjectRequest.enqueue(new Callback<Void>() {
                    ...
                    public void onResponse(Call<Void> call, Response<Void> response) {
                        ...
                        finish();
                        startActivity(new Intent(SubmitComfirm.this, SubmitSucessful.class));
                    }
                    ...
                    public void onFailure(Call<Void> call, Throwable t) {
                        ...
                        finish();
                        startActivity(new Intent(SubmitComfirm.this, SubmitFailed.class));
                    }
                });
            }
        });
